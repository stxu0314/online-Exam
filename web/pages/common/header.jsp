...
<div class="header">
    ...
    <div class="header-left">
        ...
        <a href="../index.jsp" class="logo logo-small">
            <img src="${pageContext.request.contextPath}/static/img/logo-small.png" alt="Logo" width="30" height="30">
        </a>
    </div>
    <!-- /Logo -->
                                ...
                                <div class="media">
												<span class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" alt="User Image"
                                                         src="${pageContext.request.contextPath}/static/img/profiles/avatar-02.jpg">
												</span>
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
												<span class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" alt="User Image"
                                                         src="${pageContext.request.contextPath}/static/img/profiles/avatar-11.jpg">
												</span>
                                    <div class="media-body">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
												<span class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" alt="User Image"
                                                         src="${pageContext.request.contextPath}/static/img/profiles/avatar-17.jpg">
												</span>
                                    <div class="media-body">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
												<span class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" alt="User Image"
                                                         src="${pageContext.request.contextPath}/static/img/profiles/avatar-13.jpg">
												</span>
                                    <div class="media-body">
