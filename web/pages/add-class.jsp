                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="class.jsp">仪表板</a></li>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-body">
									<form method="post" action="${pageContext.request.contextPath}/clazzServlet">
										<input type="hidden" name="action" value="addClazz">
										<div class="row">
											<div class="col-12">
												<h5 class="form-title"><span>班级信息</span></h5>
											</div>
