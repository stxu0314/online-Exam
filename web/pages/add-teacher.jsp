                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">添加老师</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="teachers.jsp">老师列表</a></li>
									<li class="breadcrumb-item active">添加老师</li>
								</ul>
							</div>
						</div>
					</div>
									...
									<form method="post" action="${pageContext.request.contextPath}/userServlet">
										...
										<div class="row">
											...
											<div class="col-12">
												...
												<span style="color:red">${uMsg1}</span>
											</div>
										</div>
									</form>
								</div>
