					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto text-right float-right ml-auto">
								...
								<a href="${pageContext.request.contextPath}/pages/add-teacher.jsp" class="btn btn-primary"><i class="fas fa-plus"></i> 添加老师</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
									...
									<div class="table-responsive">
										...
										<script>
											function deleteUser(name,userid){
												if (confirm("是否要删除老师" + name + "?")) {
													$.post("${pageContext.request.contextPath}/userServlet",{"action":"deleteUserById","userid":userid}
															,function (data) {
																if (data.result){
																	alert("删除成功！")
																	window.location.href="${pageContext.request.contextPath}/userServlet?action=findUsers&part=1"
																}
															},"json")
												}else {
													return false;
