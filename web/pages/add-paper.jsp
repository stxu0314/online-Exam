                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">添加试卷</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="">试卷</a></li>
									<li class="breadcrumb-item active">添加试卷</li>
								</ul>
							</div>
						</div>
					</div>
									...
									<form method="post" action="${pageContext.request.contextPath}/paperServlet">
										...
										<div class="row">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>单选分数</label>
													<input type="text" name="score_sin" class="form-control">
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>多选分数</label>
													<input type="text" name="score_che" class="form-control">
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>判断分数</label>
													<input type="text" name="score_jug" class="form-control">
												</div>
											</div>
