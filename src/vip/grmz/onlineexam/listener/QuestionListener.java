...
/**
 * @author: 苏
 * @createDate: 2022-10-05 15:45
 * @description:
 */
// 有个很重要的点 QuestionListener 不能被spring管理，要每次读取excel都要new,然后里面用到spring可以构造方法传进去
@Slf4j
public class QuestionListener implements ReadListener<Question> {
     ...
     * @param demoDAO
     */
    public QuestionListener(QuestionDao demoDAO) {
